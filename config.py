...
class Config:
    ...
    # DATABASE_URL is validated and set in app.py — do NOT set a fallback here
...
YOUTUBE_CHANNEL_ID = "https://www.youtube.com/cpcnewhaven"  # CPC New Haven YouTube channel
