...
with app.app_context():
    ...
    admin.add_view(ContentFeedView(name='All content', endpoint='content_feed', category='More'))
    admin.add_view(LiveContentView(name='Live content', endpoint='live_content', category='More'))
    ...
    admin.add_view(PodcastSeriesView(PodcastSeries, db.session, name='Podcast Series', category='More'))
    admin.add_view(PodcastEpisodeView(PodcastEpisode, db.session, name='Podcasts'))
    admin.add_view(SermonSeriesView(SermonSeries, db.session, name='Sermon Series', category='More'))
    ...
    admin.add_view(TeachingSeriesOverviewView(name='Teaching Series', endpoint='teaching_series_overview', category='More'))
    admin.add_view(TeachingSeriesView(TeachingSeries, db.session, name='Teaching Series', category='More'))
    admin.add_view(ReorderEventsView(name='Reorder events', endpoint='reorder_events', category='More'))
    admin.add_view(BannerAlertView(name='Banner alert', endpoint='banner_alert', category='More'))
    admin.add_view(ReorderSessionsView(name='Reorder Sessions', endpoint='reorder_sessions', category='More'))
    admin.add_view(TeachingSeriesSessionView(TeachingSeriesSession, db.session, name='Series Sessions', category='More'))
    admin.add_view(QuickAddSessionsView(name='Quick Add Sessions', endpoint='quick_add_sessions', category='More'))
